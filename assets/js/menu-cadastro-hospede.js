...
const urlId = "https://one-challenge-springboot-hotel.onrender.com/reservas";
...
persist.addEventListener('click', async () => {
    ...
    try {
        const resposta = await fetch("https://one-challenge-springboot-hotel.onrender.com/hospedes", {
            method: "POST",
            headers: {
